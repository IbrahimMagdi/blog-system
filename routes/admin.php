...
route_post(ADMIN.'/news/edit', 'controllers.admin.news.edit');
...
route_post(ADMIN.'/comments/edit', 'controllers.admin.comments.edit');
...
route_post(ADMIN.'/users/edit', 'controllers.admin.users.edit');
